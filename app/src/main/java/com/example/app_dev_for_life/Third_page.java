    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        measureButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                ...
                Log.i("ASUTOSH_DBG", String.format(" strValue1 : %s , strValue2 : %s", strValue1, strValue2));
                ...
                Thread thread = new Thread(() -> {
                    ...
                    try {
                        ...
                        Log.i("ASUTOSH_DBG", "URL Excception");
                        throw new RuntimeException(e);
                    }
                    ...
                    try {
                        ...
                        Log.i("ASUTOSH_DBG", "URL GET Exception");
                        throw new RuntimeException(e);
                    }

                    int responseCode = 0;
                    Log.i("ASUTOSH_DBG", "Till Here!!!!");
                    try {
                        responseCode = connection.getResponseCode();
                        Log.i("ASUTOSH_DBG", String.format("URL Response Code %d", responseCode));
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                    ...
                    if (responseCode == HttpURLConnection.HTTP_OK) {
                        ...
                        try {
                            ...
                            Log.i("ASUTOSH_DBG", "Buffer Reader Exception");
                            throw new RuntimeException(e);
                        }
                        String inputLine;
                        ...
                        while (true) {
                            try {
                                ...
                                Log.i("ASUTOSH_DBG", " READ Exception");
                                throw new RuntimeException(e);
                            }
                        ...
                        Log.i("Asutosh_dbg", "JSON Output : "+jsonResponse);
                        ...
                        try {
                            ...
                            for (int i = 0; i < rows.length(); i++) {
                                ...
                                for (int j = 0; j < elements.length(); j++) {
                                    ...
                                    Log.i("Asutosh_DBG", String.format("duration : %f", durValue));
                                    Log.i("Asutosh_DBG", String.format("distance : %f", distValue));
                                    Log.i("Asutosh_DBG", String.format("duration_in_traffic : %f", durTraffic));
                        ...
                        // Handle error
                        Log.i("ASUTOSH_LOG", "Error Occurred while calling MAPS API !!!!!!");
                    }
                });
...
//                    }
//
//                    Log.i("Asutosh_dbg","RESPONSE JSON : " + response.toString());
//                    // Parse the JSON response
//                    try {
                    ...
                    try {
                        ...
                        for (int i = 0; i < routes.length(); i++) {
                            ...
                            for (int j = 0; j < speedIntrvls.length(); j++) {
                                ...
                                Log.i("ASutosh_DG", speed);
                            }
                        }

                        // Do something with the duration and disatance values
//                        Log.i("Asutosh_DBG", ("duration : " + dur));
//                        Log.i("Asutosh_DBG", String.format("distance : %f", dist));

                        Log.i("Asutosh_DG", speedStr);
