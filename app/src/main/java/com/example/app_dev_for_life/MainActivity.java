...
class DBClassHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        Log.i("ASUTOSH_DB","creating table");
    ...
    public boolean insertSymptomData(float nausea, float headache, float diarrhea, float soarThroat, float fever,
        ...
        Log.i("ASUTOSH_DB", "Inserting Symptom Data!!");
    ...
    public boolean insertSignData(float HeartRate, float RespRate) {
        ...
        Log.i("ASUTOSH_DB", "Inserting Sign Data!!");
        ...
        try {
            ...
            if (cursor != null) {
                while (cursor.moveToNext()) {
                    ...
                    Log.i("ASUTOSH_DB", "ID : " + id);
                    Log.i("ASUTOSH_DB", COLUMN_NAUSEA + " : " + column1);
                    Log.i("ASUTOSH_DB", COLUMN_HEADACHE + " : " + column2);
                    Log.i("ASUTOSH_DB", COLUMN_DIARRHEA + " : " + column3);
                    Log.i("ASUTOSH_DB", COLUMN_SOAR_THROAT + " : " + column4);
                    Log.i("ASUTOSH_DB", COLUMN_FEVER + " : " + column5);
                    Log.i("ASUTOSH_DB", COLUMN_MUSCLE_ACHE + " : " + column6);
                    Log.i("ASUTOSH_DB", COLUMN_LOSS_OF_SMELL_TASTE + " : " + column7);
                    Log.i("ASUTOSH_DB", COLUMN_COUGH + " : " + column8);
                    Log.i("ASUTOSH_DB", COLUMN_SHORTNESS_OF_BREATH + " : " + column9);
                    Log.i("ASUTOSH_DB",  COLUMN_FEELING_TIRED + " : " + column10);
                    Log.i("ASUTOSH_DB",  COLUMN_HEART_RATE + " : " + column11);
                    Log.i("ASUTOSH_DB",  COLUMN_RESPIRATORY_RATE + " : " + column12);
                ...
                Log.i("ASUOTSH_DB", "Error reading DB!");
            }
        } finally {
            Log.i("ASUTOSH_DB", "FInALLy BLOCK");
...
//            Log.i("ASUTOSH_DB","Exception caugh while creating a DB");
...
//                        Toast.LENGTH_SHORT).show();
                ...
                if(is_recording_in_progress) {
                    ...
                    if (path.exists()) {
                        ...
                        if (path.delete()) {
                            Log.i("ASUTOSH_FILE", "File deleted successfully");
                        }
                        else {
                            Log.i("ASUTOSH_FILE", "Failed to delete the file");
                        }
                    } else {
...
//                Toast.makeText(getApplicationContext(), "Uploading in progress...!!", Toast.LENGTH_SHORT).show();
                ...
                Log.i("ASUTOSH_DB", String.format("HEART RATE : %f ", HR));
                Log.i("ASUTOSH_DB", String.format("RESP RATE : %f" , RR));
...
//
//                    Log.i("ASUTOSH_DB", String.format("HEART RATE : %d ", HR));
//                    Log.i("ASUTOSH_DB", String.format("RESP RATE : %d" , RR));
//
//                    sqldb.setTransactionSuccessful();
//
//                } catch(SQLiteException e) {
