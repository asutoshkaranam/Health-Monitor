...
public class Second_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("ASUTOSH_DB", "Calling init get data");
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener()
        {
            ...
            public void onRatingChanged(RatingBar ratingBar, float val, boolean t)
            {
                ...
                Log.i("ASUTOSH_DB", String.format(" The Index is : %d and Rating is %f", index, val));
        ...
        id_button6.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                ...
                Log.i("ASUTOSH_DB", "OnClick Upload Button!!");
...
//                            Toast.LENGTH_SHORT).show();
//                    Log.i("ASUTOSH_DB", "EXCEPTION CAUGHT WHILE UPDATING");
//                } finally {
////                    Toast.makeText(getApplicationContext(),
...
//                            Log.i("ASUTOSH_DB","Column1: " + column1);
//                            Log.i("ASUTOSH_DB","Column2: " + column2);
//                            Log.i("ASUTOSH_DB","Column3: " + column3);
//                            Log.i("ASUTOSH_DB","Column4: " + column4);
//                            Log.i("ASUTOSH_DB","Column5: " + column5);
//                            Log.i("ASUTOSH_DB","Column6: " + column6);
//                            Log.i("ASUTOSH_DB","Column7: " + column7);
//                            Log.i("ASUTOSH_DB","Column8: " + column8);
//                            Log.i("ASUTOSH_DB","Column9: " + column9);
//                            Log.i("ASUTOSH_DB","Column10: " + column10);
//
//
